...
<h1 align="center">
  How to deploy an HTML site to production
</h1>
...
This is the code to accompany the tutorial available in our deployment guide [How to deploy an HTML site to production](https://codecapsules.io/docs/deployment/how-to-deploy-static-html-to-production/).
